...
<head>
  ...
  <link rel="icon" type="image/png" href="../complementos/assets/img/favicon.png">
    ...
    <div class="page-header error-page header-filter" style="background-image: url('../../assets/img/clint-mckoy.jpg')">
      ...
      <div class="content-center">
        ...
        <div class="card-footer justify-content-center">
          <a href="${pageContext.request.contextPath}/tablas/visualizar" class="btn btn-danger btn-link btn-lg">Regresar</a>
        </div>
        </div>
      </div>
      <footer class="footer">
