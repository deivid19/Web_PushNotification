              ...
              <form id="TypeValidation" class="form-horizontal" action="" method="">
                <div class="card ">
                  <div class="card-header card-header-rose card-header-text">
                    <div class="card-text">
                      <h4 class="card-title">Modificar Información</h4>
                    </div>
                  </div>
                  <div class="card-body ">
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input class="form-control" value="Ejemplo1" type="text" name="nombreCom" required="true" />
                        </div>
                      </div>
                      <label class="col-sm-2 col-form-label">Sitio Web</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input class="form-control" value="ejemplo1.com" type="text" name="sitioWeb" required="true" />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <label class="col-sm-2 col-form-label">Distintivos Empresariales</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input class="form-control" value="Tiger Nixon" type="text" name="email" email="true" required="true" />
                        </div>
                      </div>
                      <label class="col-sm-2 col-form-label">Fecha Fundación Empresa</label>
                      <div class="col-sm-3">
                        <div class="form-group">
                          <input type="text" class="form-control datepicker" value="04-21-2011">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <label class="col-sm-2 col-form-label">Actividad Empresarial</label>
                      <div class="col-sm-3">
                        <select class="selectpicker" data-size="7" data-style="btn btn-primary btn-round" title="Single Select">
                          <option disabled selected> Seleccionar </option>
                          <option value="1">System Architect</option>
                          <option value="2">Is great</option>
                          <option value="3">Is bum</option>
                          <option value="4">Is wow</option>
                          <option value="5">boom</option>
                        </select>
                      </div>
                    </div>
                    <div class="row">
                      <label class="col-sm-2 col-form-label">Actividad Específica</label>
                      <div class="col-sm-3">
                        <select class="selectpicker" data-style="select-with-transition" multiple title="Seleccionar " data-size="7">
                          ...
                          <option value="6">Piatra Neamt</option>
                          <option value="7">Paris </option>
                          <option value="8">Bucharest</option>
                          <option value="9">Rome</option>
                          <option value="10">New York</option>
                          <option value="11">Miami </option>
                          <option value="12">Piatra Neamt</option>
                          <option value="13">Paris </option>
                          <option value="14">Bucharest</option>
                          <option value="15">Rome</option>
                          <option value="16">New York</option>
                          <option value="17">Miami </option>
                          <option value="18">Piatra Neamt</option>
                        </select>
                      </div>
                      <label class="col-sm-3 col-form-label">Principal producto y/o Servicio</label>
                      <div class="col-sm-3">
                        <div class="form-group">
                          <input class="form-control" value="none" id="idSource" type="text" placeholder="" required="true" />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <label class="col-sm-2 col-form-label">Numero de Colaboradores</label>
                      <div class="col-sm-3">
                        <div class="form-group">
                          <input class="form-control" value="61" type="text" name="number" number="true" required="true" />
                        </div>
                      </div>
                    </div>
                  </div>
